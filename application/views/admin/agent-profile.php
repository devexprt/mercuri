...
<head>
	...
	<link href="../plugins/components/owl.carousel/owl.carousel.min.css" rel="stylesheet" type="text/css" />
    <link href="../plugins/components/owl.carousel/owl.theme.default.css" rel="stylesheet" type="text/css" />
                        ...
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="../plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="../plugins/images/users/jeffery.jpg" class="thumb-lg img-circle" alt="img"></a>
                                        <h4 class="text-white">Merites Manzan</h4>
                                        <h5 class="text-white">123, Demo Street, City</h5> 
										<a href="" class="fb-icon-pro"> <i class="fa fa-facebook"></i> </a>
										</div>
                                </div>
                            </div>
                            <div class="user-btm-box">
                                <div class="input-group">
									...
									<input type="text" class="form-control" id="exampleInputuname" value="demo@example.com"> 
								</div>
								<div class="input-group">
									<div class="input-group-addon"><i class=" icon-phone"></i></div>
									<input type="text" class="form-control" id="exampleInputuname" value="+1234 567 890"> 
								</div>
                            </div>
							<div class="updt-btn">
								<a href="" class="btn btn-success"> Update </a>
								<span class="pull-right"><input type="checkbox"  checked class="js-switch" data-color="#00CB77" /></span>
							</div>
                        </div>
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <ul class="nav nav-tabs tabs customtab">
                                <li class="active tab">
                                    <a href="#home" data-toggle="tab"> <span class="visible-xs"><i class="fa fa-home"></i></span> <span class="hidden-xs">Active/Inactive Policy</span> </a>
                                </li>
                                <li class="tab">
                                    <a href="#profile" data-toggle="tab"> <span class="visible-xs"><i class="fa fa-user"></i></span> <span class="hidden-xs">Document</span> </a>
                                </li>
                                <li class="tab">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="home">
									<table class="table actv-tabl">
										<tr>
											<td> EIGFSD-13333 </td>
											<td> [active]- as off Today</td>
											<td> GGAH13333 </td>
											<td> [Cancelled October] </td>
											<td> <input type="checkbox"  checked class="js-switch" data-color="#00CB77" /> </td>
										</tr>
									</table>
								</div>
                                    ...
                                    <div class="row">
										<div class="col-lg-12">
											<div class="panel panel-default">
												<div class="panel-heading tab-pro-hd">ID Cards <span class="pull-right"><input type="checkbox"  checked class="js-switch" data-color="#00CB77" /></span></div>
												<div class="panel-wrapper p-b-10 collapse in">
													<div id="owl-demo2" class="owl-carousel owl-theme pro-owl">
														<div class="item"><img src="../plugins/images/id.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/id.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/id.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/id.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/id.jpg" alt="Owl Image"></div>
											...
											<div class="panel panel-default">
												<div class="panel-heading tab-pro-hd">Declaration Page <span class="pull-right"><input type="checkbox"  checked class="js-switch" data-color="#00CB77" /></span></div>
												<div class="panel-wrapper p-b-10 collapse in">
													<div id="owl-demo3" class="owl-carousel owl-theme pro-owl">
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
											...
											<div class="panel panel-default">
												<div class="panel-heading tab-pro-hd">Vehicle List <span class="pull-right"><input type="checkbox"  checked class="js-switch" data-color="#00CB77" /></span></div>
												<div class="panel-wrapper p-b-10 collapse in">
													<div id="owl-demo4" class="owl-carousel owl-theme pro-owl">
														<div class="item"><img src="../plugins/images/car1.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/car2.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/car3.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/car4.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/car5.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/car1.jpg" alt="Owl Image"></div>
													</div>
												</div>
											</div>
											<div class="panel panel-default">
												<div class="panel-heading tab-pro-hd">Pending Signature <span class="pull-right"><input type="checkbox"  checked class="js-switch" data-color="#00CB77" /></span></div>
												<div class="panel-wrapper p-b-10 collapse in">
													<div id="owl-demo5" class="owl-carousel owl-theme pro-owl">
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
											...
											<div class="panel panel-default">
												<div class="panel-heading tab-pro-hd">Completed <span class="pull-right"><input type="checkbox"  checked class="js-switch" data-color="#00CB77" /></span></div>
												<div class="panel-wrapper p-b-10 collapse in">
													<div id="owl-demo6" class="owl-carousel owl-theme pro-owl">
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
														<div class="item"><img src="../plugins/images/form.jpg" alt="Owl Image"></div>
                                ...
                                <div class="tab-pane" id="messages">
                                    <div class="steamline">
                                                ...
                                                <div class="m-l-40"> <a href="#" class="text-info">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                    <div class="m-t-20 row">
                                                        ...
                                                        <div class="col-md-9 col-xs-12">
                                                            <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum. Praesent mauris. Fusce nec tellus sed augue semper porta. Mauris massa</p> </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sl-item">
                                            ...
                                            <div class="sl-right">
                                                <div class="m-l-40"><a href="#" class="text-info">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                    <p>Lorem ipsum dolor sit amet  <a href="#"> consectetur adipiscing.</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div class="col-md-12">
  ...
  <script src="../plugins/components/jquery/dist/jquery.min.js"></script>
	...
	<script src="../plugins/components/switchery/dist/switchery.min.js"></script>
    <script src="js/sidebarmenu.js"></script>
    <script src="js/jquery.slimscroll.js"></script>
    <script src="js/waves.js"></script>
    <script src="js/custom.js"></script>
    <script src="../plugins/components/styleswitcher/jQuery.style.switcher.js"></script>
	<script src="../plugins/components/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js" type="text/javascript"></script>
	<script src="../plugins/components/owl.carousel/owl.carousel.min.js"></script>
    <script src="../plugins/components/owl.carousel/owl.custom.js"></script>
	 <script>
