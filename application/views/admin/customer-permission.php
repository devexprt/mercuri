...
<?php include 'sidebar.php';?><div class="page-wrapper">
                ...
                <!-- /row -->
                    ...
                    <div class="col-sm-12 for_padd">
                        <div class="white-box">
                            <div class="row">
								<div class="col-md-12">
									<h3 class="box-title m-t-0 m-b-0">Customer Permission</h3>
								</div>
			...
			<tbody>
			<tr>
	<td>Manage Contact Info</td>


			<td class="fnt-weight-700">
				<input type="checkbox" checked class="js-switch" data-color="#00CB77" />
...
<td></td>
	...
	<td>Manage Vehicle </td>
			...
			<td class="fnt-weight-700">
				<input type="checkbox" checked class="js-switch" data-color="#00CB77" />			</td>
							<td>
<div class="checkbox checkbox11 m-t-0 m-b-0">
                                                <input type="checkbox" id="ch1">
                                                <label for="ch1"> Add</label>
                                             </div>
									</td>
			<td>									
				<div class="checkbox checkbox11 m-t-0 m-b-0">
                                                <input type="checkbox" id="ch2">
                                                <label for="ch2"> View</label>
                                             </div>							 
			</td>
...
<script src="assets/admin/js/editor.js"></script>
    ...
    <script src="assets/admin/assets/admin/js/bootstrap-tagsinput.js"></script>
