                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Tiger Nixon</td>
											<td>123, Demo City, CA</td>
											<td>+1234 567 890</td>
                                            <td>demo@exapmle.com</td>
                                            <td>Customer</td>
											<td>
                                        ...
                                        <tr>
                                            <td>John Smith</td>
											<td>002 Street, California</td>
											<td>+9990 343 322</td>
                                            <td>john@example.com</td>
                                            <td>Prospect</td>
											<td>
												<button type="button" class="btn btn-info btn-circle"><i class="fa fa-plus"></i> </button>
												<input type="checkbox"  class="js-switch" data-color="#00CB77" />
											</td>
                                        </tr>
										 <tr>
                                            <td>Hanry James</td>
											<td>123 Street, California</td>
											<td>+4223 234 344</td>
                                            <td>hanry@exapmle.com</td>
                                            <td>Customer</td>
											<td>
												<button type="button" class="btn btn-info btn-circle"><i class="fa fa-plus"></i> </button>
												<input type="checkbox" checked class="js-switch" data-color="#00CB77" />
										 ...
										 <tr>
                                            <td>Marry James</td>
											<td>111 Street, New York NY</td>
											<td>+0000 888 888</td>
                                            <td>marry@exapmle.com</td>
                                            <td>Prospect</td>
											<td>
												<button type="button" class="btn btn-info btn-circle"><i class="fa fa-plus"></i> </button>
												<input type="checkbox"  class="js-switch" data-color="#00CB77" />
										 ...
										 <tr>
                                            <td>Thomson</td>
											<td>999 Street, California</td>
											<td>+7743 344 322</td>
                                            <td>thomson@exapmle.com</td>
                                            <td>Customer</td>
											<td>
												<button type="button" class="btn btn-info btn-circle"><i class="fa fa-plus"></i> </button>
												<input type="checkbox" checked class="js-switch" data-color="#00CB77" />
										 ...
										 <tr>
                                            <td>Harry Potter</td>
											<td>112 Demo Street, NY</td>
											<td>+1122 322 233</td>
                                            <td>harry@exapmle.com</td>
                                            <td>Prospect</td>
											<td>
												<button type="button" class="btn btn-info btn-circle"><i class="fa fa-plus"></i> </button>
												<input type="checkbox"  class="js-switch" data-color="#00CB77" />
