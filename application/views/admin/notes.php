                ...
                <!-- /row -->
                    ...
                    <div class="col-sm-12 for_padd">
                        <div class="white-box">
                            <div class="row">
								<div class="col-md-12">
									<h3 class="box-title m-t-0 m-b-0">Notes</h3>
								</div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="table-responsive">
                                 <table id="myTable12" class="table table-striped">
                                    ...
                                    <tbody>
                                       <tr>
                                           <td><img src="assets/admin/img/notes1.png"/></td>
                                          <td>REYVIE PAZ</td>
...
<div class="col-md-12">
      ...
      </div> <div class="modal fade" id="add-comment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
