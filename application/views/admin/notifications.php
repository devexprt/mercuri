...
<?php include 'sidebar.php';?>  <!-- ===== Page-Content ===== -->
         <div class="page-wrapper">
            ...
            <div class="container-fluid">
               ...
               <div class="white-box">
                           <h3 class="box-title m-t-0">Notifications</h3> 
  ...
  <li class="notification">
      <div class="media">
        <div class="media-left">
          <div class="media-object">
            <img src="assets/admin/plugins/images/users/hanna.jpg" class="img-circle" width="70px">
          </div>
        </div>
        <div class="media-body">
          <strong class="notification-title">Dave Lister</strong><span class="text-muted pull-right"><i class="icon-phone"></i> 987230123</span>
          <p class="notification-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>

          <div class="notification-meta">
            <small class="timestamp"><i class="icon-calender"></i> 27/11/7, 15:00 AM</small>
          </div>
        </div>
      </div>
  </li>
    <li class="notification">
      <div class="media">
        <div class="media-left">
          <div class="media-object">
            <img src="assets/admin/plugins/images/users/2.jpg" class="img-circle" width="70px">
          </div>
        </div>
        <div class="media-body">
          <strong class="notification-title">John Smith</strong><span class="text-muted pull-right"><i class="icon-phone"></i> 987230123</span>
          <p class="notification-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
    ...
    <li class="notification">
      <div class="media">
        <div class="media-left">
          <div class="media-object">
            <img src="assets/admin/plugins/images/users/jeffery.jpg" class="img-circle" width="70px">
          </div>
        </div>
        <div class="media-body">
          <strong class="notification-title">John Doe</strong><span class="text-muted pull-right"><i class="icon-phone"></i> 987230123</span>
          <p class="notification-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
        ...
        <div class="media-body">
          ...
          <div class="notification-meta">
            <small class="timestamp"><i class="icon-calender"></i> 27/11/7, 15:00 AM</small>
                                ...
                                <div class="task-loadmore load-more">
                                    <a href="javascript:void(0);" class="btn btn-default btn-outline btn-rounded">View More</a>
                                </div>
