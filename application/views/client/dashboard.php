...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="assets/client/plugins/images/favicon.png">
    <title>Dashboard</title>
     <link href="assets/client/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="assets/client/plugins/components/chartist-js/dist/chartist.min.css" rel="stylesheet">
    <link href="assets/client/plugins/components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css" rel="stylesheet">
                        ...
                        <div class="white-box activity-widget">
                            ...
                            <div class="steamline">
                                <div class="sl-item">
                                    <div class="sl-left">
                                        <div>
                                            <img class="img-circle" alt="user" src="assets/client/plugins/images/users/hanna.jpg">
                                        </div>
                                    </div>
                                    <div class="sl-right">
                                ...
                                <div class="sl-item">
                                    <div class="sl-left">
                                        <div>
                                            <img class="img-circle" alt="user" src="assets/client/plugins/images/users/2.png">
                                        </div>
                                    </div>
                                    <div class="sl-right">
